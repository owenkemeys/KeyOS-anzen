...
Implement Luke's current 65,535-block HWW recovery path with host/regtest proof.
Do not claim that Prime learned chain state through a production transport.
